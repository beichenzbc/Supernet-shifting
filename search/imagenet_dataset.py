...
def main():
    ...
    train_dataprovider = get_train_dataprovider(train_batch_size, use_gpu=use_gpu, num_workers=8)
    val_dataprovider = get_val_dataprovider(valid_batch_size, use_gpu=use_gpu, num_workers=8)
